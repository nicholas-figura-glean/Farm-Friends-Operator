...
PROBES = {
    ...
    "rival_regime_replay": {
        "hypothesis": "A rival wake, growth, or threat episode is no longer decision-material when our score lead keeps widening and the rival has no material herd or score gain in the current window.",
        "question_classes": ["rival_wake", "rival_growing", "threat"],
        "subject_patterns": [],
        "command": ["experiments/rival_regime_probe.py"],
        "read_only": True,
        "autonomous": True,
        "budget": {"coins": 0, "calls": 0, "wall_seconds": 30},
        "tools": {},
        "outputs": ["rival_regime_probe.json"],
        "stop_condition": "the current 40-run score/herd regime is classified for each named rival",
        "evidence_destination": "state/rival_regime_probe.json",
    },
