...
for f in dashboard/trace_explorer.js dashboard/test_trace_explorer.js dashboard/preview_trace_explorer.js \
         dashboard/mcp_wire.js dashboard/test_mcp_wire.js dashboard/preview_mcp_wire.js; do
...
for f in deploy/test_tool_trace.py deploy/test_dashboard.py deploy/preview_trace_explorer.py \
         deploy/preview_mcp_wire.py farm/mcp.py monitor.py; do
